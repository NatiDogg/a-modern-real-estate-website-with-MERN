...
const SideBar = () => {
  ...
  return (
     <section className='w-full px-1 bg-linear-to-r from-[#fffbee] to-white'>
         <div className='max-w-[1460px] mx-auto px-1 py-1 md:px-2 md:py-2 flex flex-col md:flex-row gap-8 md:gap-10'>
              <div className='min-w-[10%] md:min-w-[25%] md:min-h-[97vh] flex flex-col gap-4 border border-white bg-white shadow rounded-md  '>
                 ...
                 <div className='flex md:flex-col gap-6 mt-5 w-full '>
