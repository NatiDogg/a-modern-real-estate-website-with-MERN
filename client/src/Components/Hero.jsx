...
const Hero = () => {
    const {navigate,axios,getToken,searchedCities,setSearchedCities} = useContext(AppContext);
           ...
           <div className='z-10 flex flex-col justify-end py-10 px-8 h-screen w-screen'>
             ...
             <div className='flex z-10 flex-col items-start gap-4 text-white'>
                ...
                <div className=' w-full relative text-black '>
                     <form onSubmit={onSearch} className='bg-white px-4 py-3 rounded-md grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6 z-20  '>
                         <div className='flex flex-col gap-1 '>
                           ...
                           <input  value={destination} onChange={(e)=>{
                            ...
                            {
                              showSearch && searchedCities.length > 0  ? <div className='absolute bottom-80 lg:bottom-20 bg-white rounded-sm w-[50%] md:w-[20%] grid place-content-start py-3 px-4'>
                         ...
                         <div className='flex flex-col gap-1'>
                           ...
                           <input   id='guests' placeholder='1' type="number" min={1} max={5} className='border text-sm border-gray-300 text-gray-700 outline-none  focus:border-gray-900 rounded-sm px-2 py-1' />
